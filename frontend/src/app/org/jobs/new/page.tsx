...
// The corresponding inputs all use { valueAsNumber: true } so RHF converts
// the HTML string value to a JS number before Zod validates it.
// z.coerce.number() types the input as `unknown`, breaking useForm<FormData>.
  ...
  async function onSubmit(data: FormData) {
    ...
    try {
      ...
      if (err?.response?.status === 402) {
        toast.error(detailMsg ?? "No free posts left — purchase a job point to continue.");
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <Section title="Location & Salary" step="2">
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                {/* valueAsNumber: true on all number inputs */}
