...
// ── Schema ─────────────────────────────────────────────────────────────────
// All numeric fields use z.number() + { valueAsNumber: true } on the input.
// This keeps the TS type as `number` throughout, satisfying useForm<FormData>.
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="card space-y-4">
              ...
              <Field label="Job Title *" error={errors.title?.message}>
                <input {...register("title")} className="input" placeholder="e.g. Senior Accountant" />
              </Field>
            ...
            <div className="card space-y-4">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                {/* valueAsNumber: true converts the string from <input type="number">
                    to a JS number before RHF hands it to Zod. Required for z.number(). */}
